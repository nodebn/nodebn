...
- Categorized product shelves: Products displayed in sections by category, sorted by custom order, with navigation dropdown
...
- Storefront styling: Minimalist category headers with separators, dropdown navigation

## Current Task

Run RLS policies for anonymous access to enable storefront display.

## Next Steps

1. Execute RLS policies in Supabase
2. Test storefront shelves and dropdown navigation
3. Deploy and finalize

## Important Files

- @components/storefront/product-grid.tsx - Shelves with dropdown nav
